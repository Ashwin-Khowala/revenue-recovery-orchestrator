        ...
        <div className="max-w-[1600px] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 text-xs font-semibold">
            ...
            <Link
              ...
              className="px-3 py-1.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 transition-colors inline-flex items-center gap-1.5"
            >
        ...
        <div className="flex-1 w-full space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
              ...
              <div className="text-[11px] text-amber-600 font-semibold mt-1 inline-flex items-center gap-1">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
              ...
              <div className="text-[11px] text-emerald-700 font-semibold mt-1 inline-flex items-center gap-1">
                ...
                <span>Hard Guardrail Verified</span>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div>
                <h2 className="text-sm font-bold text-slate-900 inline-flex items-center gap-1.5">
                  ...
                  <span>Dynamic EV Policy Simulator</span>
                </h2>
